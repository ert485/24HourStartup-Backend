...
{
    public abstract class Team5WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Team5WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Team5WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Team5DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Team5DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Team5DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Team5DbContext, Task<T>> func)
        {
            T result;
